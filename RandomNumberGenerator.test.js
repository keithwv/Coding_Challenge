...
test("CreateRandomArray function generates an array with a length of 10,000", () => {
  expect(createRandomArray(1, 10000)).toHaveLength(10000);
});

test("CreateRandomArray function generates an array where all values are unique", () => {
